...
const Home = () => {
    ...
    return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: showModal ? ((0, jsx_runtime_1.jsx)(CreateDocModal_1.default, { setShowModal: setShowModal })) : loading ? ((0, jsx_runtime_1.jsx)(Loader_1.default, {})) : ((0, jsx_runtime_1.jsx)("div", { className: 'container mx-auto md:px-10 px-4 md:py-8 py-3', children: (0, jsx_runtime_1.jsxs)("div", { className: 'grid md:grid-cols-5 grid-cols-2', children: [(0, jsx_runtime_1.jsx)("button", { onClick: () => setShowModal(true), children: (0, jsx_runtime_1.jsx)("div", { className: 'bg-gray-200  flex items-center justify-center py-12', children: (0, jsx_runtime_1.jsx)(react_fontawesome_1.FontAwesomeIcon, { className: 'text-3xl', icon: free_solid_svg_icons_1.faPlus }) }) }), documents.map((document) => {
